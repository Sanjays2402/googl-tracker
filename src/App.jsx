...
const PROXY = '/api/yahoo/v8/finance/chart/GOOGL'
...
/* Google 4-color G logo as SVG */
function GoogleLogo({ size = 32 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48">
      <path d="M43.611 20.083H42V20H24v8h11.303c-1.649 4.657-6.08 8-11.303 8-6.627 0-12-5.373-12-12s5.373-12 12-12c3.059 0 5.842 1.154 7.961 3.039l5.657-5.657C34.046 6.053 29.268 4 24 4 12.955 4 4 12.955 4 24s8.955 20 20 20 20-8.955 20-20c0-1.341-.138-2.65-.389-3.917z" fill="#FBBC05"/>
      ...
      <path d="M24 44c5.166 0 9.86-1.977 13.409-5.192l-6.19-5.238A11.91 11.91 0 0 1 24 36c-5.202 0-9.619-3.317-11.283-7.946l-6.522 5.025C9.505 39.556 16.227 44 24 44z" fill="#34A853"/>
      <path d="M43.611 20.083H42V20H24v8h11.303a12.04 12.04 0 0 1-4.087 5.571l.003-.002 6.19 5.238C36.971 39.205 44 34 44 24c0-1.341-.138-2.65-.389-3.917z" fill="#4285F4"/>
    </svg>
  )
}
...
export default function App() {
  ...
  return (
    <div style={{ position: 'relative', zIndex: 1, maxWidth: 1200, margin: '0 auto', padding: '40px 24px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 8 }}>
          ...
          <div>
            <h1 style={{
              ...
              Google <span style={{ color: 'var(--text-3)', fontWeight: 500, fontSize: 24 }}>GOOGL</span>
            </h1>
      ...
      >
        {[
          { label: 'Market Cap', value: formatBigNum(meta.marketCap || (price * 12.06e9)) },
